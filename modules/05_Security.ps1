...
Write-ModuleHeader "05" "🛡️" "SECURITY HARDENING"
$applied = 0
...
Write-OK "Defender: RealTime=ON, Cloud=HIGH, PUA=ON, NetworkProtect=ON, CFolderAccess=ON"
...
$ports = @(
    ...
    @{Port="3389"; Name="RDP"},       @{Port="5900"; Name="VNC"},
