# NeoOptimize ΓÇö Manual Testing Script
...
function Test-Result($name, $ok, $msg = "") {
    ...
    else      { Write-Host "  [FAIL] $name ΓÇö $msg" -ForegroundColor Red; $global:Fail++ }
    $global:Logs += [pscustomobject]@{ Test = $name; Result = if ($ok) { "PASS" } else { "FAIL" }; Message = $msg }
}

function Skip-Test($name, $reason) {
    Write-Host "  [SKIP] $name ΓÇö $reason" -ForegroundColor Yellow
    $global:Skip++
...
# ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
if ($All -or $Bloatware) {
    Write-Host "`nΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöü" -ForegroundColor Cyan
    Write-Host " TEST: Bloatware Database & Scan" -ForegroundColor Cyan
    Write-Host "ΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöü" -ForegroundColor Cyan
    ...
    if ($db) {
        ...
        Write-Host "  ΓåÆ Installed bloatware detected: $($hits.Count) apps" -ForegroundColor White
...
if ($All -or $Models) {
    ...
    if (Test-Path $onnxPath) {
        ...
        Write-Host "  [INFO] ONNX model not present ΓÇö will be auto-downloaded on first launch." -ForegroundColor Yellow
        $global:Skip++
    }
    ...
    if ($ggufFiles) {
        ...
        Write-Host "  [INFO] No GGUF model ΓÇö app will use Cloud AI fallback." -ForegroundColor Yellow
        $global:Skip++
    }
}
...
# Summary
# ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
Write-Host "`nΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöü" -ForegroundColor White
Write-Host " HASIL: PASS=$Pass  FAIL=$Fail  SKIP=$Skip" -ForegroundColor $(if ($Fail -eq 0) { 'Green' } else { 'Red' })
Write-Host "ΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöüΓöü" -ForegroundColor White
