...
if (-not (Test-NeoHighRiskConsent -ActionName "Network Optimizer" -RiskLevel "High" -Reason "Mengubah TCP/IP, DNS, DoH, NetBIOS, firewall/hosts, dan parameter network global.")) {
    Wait-AnyKey
    return
}
